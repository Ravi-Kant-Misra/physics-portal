...
function doGet() {
  ...
  var html = '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>IB Physics Portal</title>'+css+'</head><body>'+
    '<header><div class="hi"><a href="https://ravi-kant-misra.github.io/physics-portal/" style="display:inline-block;margin-bottom:14px;color:rgba(255,255,255,.7);font-size:.82rem;font-weight:700;text-decoration:none;">← Back to Site</a><div class="lbl">IB Physics Portal</div><h1>'+student.StudentName+'</h1></div></header>'+
